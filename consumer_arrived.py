...
def process_arrived_queue(ch, method, properties, body):
    try:
        ...
        subject = f"Trailer {data['trailer_id']} has arrived at {data['location']}"
        body = f"Trailer {data['trailer_id']} arrived at {data['location']} at {data['arrival_timestamp']}."
...
if __name__ == "__main__":
    queue_name = "arrived_queue"
    start_listening(queue_name, process_arrived_queue)
