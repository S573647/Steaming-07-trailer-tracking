...
def process_arriving_queue(ch, method, properties, body):
    try:
        ...
        subject = f"Trailer {data['trailer_id']} is arriving  at {data['location']}"
        body = f"Trailer {data['trailer_id']} is arriving at {data['location']} at {data['arrival_timestamp']}."
...
if __name__ == "__main__":
    queue_name = "arriving_queue"
    start_listening(queue_name, process_arriving_queue)
